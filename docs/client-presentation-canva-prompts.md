...
The emotional arc moves from *seriousness of the mandate* → *credibility of the approach* → *evidence* → *confidence* → *forward momentum*.
...
**Composition & spacing:** Clear hierarchy per slide: *kicker label → headline → one supporting line → structured content*. Use whitespace as a design element. Align everything to the grid.
