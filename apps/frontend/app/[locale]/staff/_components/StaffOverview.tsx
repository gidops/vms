...
function StatCell({ stat }: { stat: StaffStat }) {
  return (
    <div className="flex flex-col gap-4 p-8">
      <span className="text-xl font-semibold text-fg-subtle">{stat.label}</span>
      <span className="text-[48px] font-bold leading-none text-fg">
        {stat.value}
      </span>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="hidden overflow-hidden rounded-xl border border-border shadow-xs lg:grid lg:grid-cols-[repeat(3,1fr)_minmax(300px,1.5fr)]">
        {/* Row 1 */}
        <div className="col-span-3 flex items-center bg-surface px-6 py-5">
